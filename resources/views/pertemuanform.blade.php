        ...
        <main class=" w-full h-[80vh] p-2 ps-5 pe-5 flex items-center justify-center">
            ...
            <div
                ...
                <form class="space-y-6" method="POST"  action="{{ route('createMeeting') }}">
                    <h1 class="text-3xl font-extrabold text-center text-custom-blue mb-6">Pertemuan</h1>
                    @csrf
                    <div>
                    ...
                    <div>
                        <button type="submit"
                            class="w-full rounded-lg bg-custom-blue px-4 py-2 text-white font-semibold shadow-md hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all duration-150">
                            Buat Pertemuan
                        </button>
                    </div>
                </form>
