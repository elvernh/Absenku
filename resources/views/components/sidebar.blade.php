...
<div id="sidebar"
    class="w-64 h-screen px-6 text-white fixed top-0 left-0 -translate-x-full transition-transform transform z-[10000] {{ $sidebarColor }}">
    ...
    <ul class="space-y-2 mt-10">
        @if ($type == 'school')
            <li
                class="{{ Request::is($type . '/dashboard') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
            ...
            <li
                class="{{ Request::is($type . '/daftarekskul') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
            ...
            <li
                class="{{ Request::is($type . '/daftarekskulaktifaktif') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
            ...
            <li
                class="{{ Request::is($type . '/daftarsiswa') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
            ...
            <li
                class="{{ Request::is($type . '/daftarvendor') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
            ...
            <li
                class="{{ Request::is($type . '/pendaftaran') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
                <a href={{ '/' . $type . '/pendaftaran' }} class="flex px-6 py-3 items-center">
                    <img src="{{ asset('icons/user.svg') }}" alt="user" class="mr-4">
                    <span class="font-medium">Pendaftaran</span>
                </a>
            </li>
            <li class="{{ Request::is('profile') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
                <a href={{ '/' . $type . '/profile' }} class="flex px-6 py-3 items-center">
                    <img src="{{ asset('icons/user.svg') }}" alt="book" class="mr-4">
                    <span class="font-medium">Profile</span>
                </a>
            </li>
            <li class="hover:bg-[#f6f6f637] rounded-lg cursor-pointer">
        ...
        @elseif ($type == 'vendor')
            ...
            <li
                class="{{ Request::is($type . '/daftarpertemuan') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
        ...
        @elseif($type == 'student')
            ...
            <li
                class="{{ Request::is($type . '/meeting') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
            ...
            <li
                class="{{ Request::is($type . '/payment') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
            ...
            <li
                class="{{ Request::is($type . 'sertifikat') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
            ...
            <li
                class="{{ Request::is('student/daftar') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
            ...
            <li
                class="{{ Request::is('profile') ? 'bg-[#f6f6f637]' : 'hover:bg-[#f6f6f637]' }} rounded-lg cursor-pointer">
                <a href={{ '/' . $type . '/profile' }} class="flex px-6 py-3 items-center">
                    <img src="{{ asset('icons/user.svg') }}" alt="book" class="mr-4">
                    <span class="font-medium">Profile</span>
                </a>
